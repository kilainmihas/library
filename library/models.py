...
class Language(models.Model):
    la = models.CharField(max_length=100, help_text='Enter the book\'s natural language(e.g. English, French, Japan etc.)')
...
class Book(models.Model):
    ...
    def display_language(self):
        return ','.join(language.la for language in self.language.all()[:3])
